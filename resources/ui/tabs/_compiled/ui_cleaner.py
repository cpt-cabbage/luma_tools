...
class Ui_CleanerTab(object):
    ...
    def retranslateUi(self, CleanerTab):
        self.FolderSize.setText(QCoreApplication.translate("CleanerTab", u"Total Size: Calculating...", None))
        self.HipNumber.setText(QCoreApplication.translate("CleanerTab", u"Total Files: 0", None))
