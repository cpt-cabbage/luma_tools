...
class Ui_MP4MakerTab(object):
    def setupUi(self, MP4MakerTab):
        ...
        sizePolicy.setHeightForWidth(self.mp4RenderPathGroupBox.sizePolicy().hasHeightForWidth())
        self.mp4RenderPathGroupBox.setSizePolicy(sizePolicy)
    ...
    def retranslateUi(self, MP4MakerTab):
        ...
        self.MP4SourceButton.setProperty(u"role", QCoreApplication.translate("MP4MakerTab", u"secondary", None))
        ...
        self.MP4BrowseCustomPath.setProperty(u"density", QCoreApplication.translate("MP4MakerTab", u"sm", None))
        self.MP4BrowseCustomPath.setProperty(u"role", QCoreApplication.translate("MP4MakerTab", u"secondary", None))
        self.MP4BrowseCustomPath.setText(QCoreApplication.translate("MP4MakerTab", u"Browse...", None))
        self.MP4ScanRenders.setProperty(u"role", QCoreApplication.translate("MP4MakerTab", u"secondary", None))
#if QT_CONFIG(tooltip)
        ...
        self.MP4QualityButton.setProperty(u"role", QCoreApplication.translate("MP4MakerTab", u"secondary", None))
