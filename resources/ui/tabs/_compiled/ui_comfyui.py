...
class Ui_ComfyUITab(object):
    ...
    def retranslateUi(self, ComfyUITab):
        self.comfyuiModelFrame.setProperty(u"variant", QCoreApplication.translate("ComfyUITab", u"panel", None))
        self.modelStepTitle.setProperty(u"textRole", QCoreApplication.translate("ComfyUITab", u"title", None))
        self.modelStepTitle.setText(QCoreApplication.translate("ComfyUITab", u"Choose Model", None))
        self.ComfyUIChoosePreset.setProperty(u"role", QCoreApplication.translate("ComfyUITab", u"ghost", None))
        ...
        self.selectedModelName.setProperty(u"textRole", QCoreApplication.translate("ComfyUITab", u"display", None))
        self.selectedModelName.setText(QCoreApplication.translate("ComfyUITab", u"Model", None))
        self.selectedModelBadge.setProperty(u"variant", QCoreApplication.translate("ComfyUITab", u"badge", None))
        self.selectedModelBadge.setText(QCoreApplication.translate("ComfyUITab", u"IMAGE", None))
        self.workflowSettingsBtn.setProperty(u"iconOnly", QCoreApplication.translate("ComfyUITab", u"true", None))
        self.workflowSettingsBtn.setProperty(u"role", QCoreApplication.translate("ComfyUITab", u"ghost", None))
...
#endif // QT_CONFIG(tooltip)
        self.editModelBtn.setProperty(u"density", QCoreApplication.translate("ComfyUITab", u"sm", None))
        self.editModelBtn.setProperty(u"role", QCoreApplication.translate("ComfyUITab", u"ghost", None))
...
#endif // QT_CONFIG(tooltip)
        self.changeModelBtn.setProperty(u"density", QCoreApplication.translate("ComfyUITab", u"sm", None))
        self.changeModelBtn.setProperty(u"role", QCoreApplication.translate("ComfyUITab", u"secondary", None))
...
#endif // QT_CONFIG(tooltip)
        self.selectedModelDesc.setProperty(u"textRole", QCoreApplication.translate("ComfyUITab", u"help", None))
        ...
        self.comfyuiInputFrame.setProperty(u"variant", QCoreApplication.translate("ComfyUITab", u"panel", None))
        self.inputStepTitle.setProperty(u"textRole", QCoreApplication.translate("ComfyUITab", u"title", None))
        self.inputStepTitle.setText(QCoreApplication.translate("ComfyUITab", u"Input", None))
        self.noteBanner.setProperty(u"variant", QCoreApplication.translate("ComfyUITab", u"note", None))
        self.noteText.setProperty(u"textRole", QCoreApplication.translate("ComfyUITab", u"help", None))
        self.noteText.setText("")
        self.comfyuiSettingsFrame.setProperty(u"variant", QCoreApplication.translate("ComfyUITab", u"panel", None))
        self.settingsStepTitle.setProperty(u"textRole", QCoreApplication.translate("ComfyUITab", u"title", None))
        self.settingsStepTitle.setText(QCoreApplication.translate("ComfyUITab", u"Settings", None))
        self.advancedGearBtn.setProperty(u"iconOnly", QCoreApplication.translate("ComfyUITab", u"true", None))
        self.advancedGearBtn.setProperty(u"role", QCoreApplication.translate("ComfyUITab", u"ghost", None))
...
#endif // QT_CONFIG(tooltip)
        self.label_count_value.setProperty(u"textRole", QCoreApplication.translate("ComfyUITab", u"value", None))
        self.label_count_value.setText(QCoreApplication.translate("ComfyUITab", u"1", None))
        self.ComfyUIEtaLabel.setProperty(u"textRole", QCoreApplication.translate("ComfyUITab", u"help", None))
        self.ComfyUIEtaLabel.setText("")
        self.advancedToggleBtn.setProperty(u"role", QCoreApplication.translate("ComfyUITab", u"link", None))
        self.advancedToggleBtn.setText(QCoreApplication.translate("ComfyUITab", u"Advanced Settings...", None))
        self.advancedSeparator.setProperty(u"variant", QCoreApplication.translate("ComfyUITab", u"divider", None))
        ...
        self.ComfyUIRandomizeSeed.setProperty(u"iconOnly", QCoreApplication.translate("ComfyUITab", u"true", None))
        self.ComfyUIRandomizeSeed.setProperty(u"role", QCoreApplication.translate("ComfyUITab", u"ghost", None))
        ...
        self.ComfyUINetworkPathDisplay.setProperty(u"textRole", QCoreApplication.translate("ComfyUITab", u"mono", None))
        self.ComfyUINetworkPathDisplay.setText(QCoreApplication.translate("ComfyUITab", u"(Not configured)", None))
        self.comfyuiSubmitFrame.setProperty(u"variant", QCoreApplication.translate("ComfyUITab", u"panel", None))
        self.submitStepTitle.setProperty(u"textRole", QCoreApplication.translate("ComfyUITab", u"title", None))
        self.submitStepTitle.setText(QCoreApplication.translate("ComfyUITab", u"Submit", None))
        self.ComfyUISubmit.setProperty(u"role", QCoreApplication.translate("ComfyUITab", u"primary", None))
        self.ComfyUISubmit.setText(QCoreApplication.translate("ComfyUITab", u"Submit to Farm", None))
        self.ComfyUICancelJobs.setProperty(u"role", QCoreApplication.translate("ComfyUITab", u"danger", None))
        self.ComfyUICancelJobs.setText(QCoreApplication.translate("ComfyUITab", u"Cancel Jobs", None))
        self.comfyuiIterateFrame.setProperty(u"variant", QCoreApplication.translate("ComfyUITab", u"panel", None))
        self.ComfyUIIterateTitle.setProperty(u"textRole", QCoreApplication.translate("ComfyUITab", u"title", None))
        self.ComfyUIIterateTitle.setText(QCoreApplication.translate("ComfyUITab", u"Progress", None))
        self.ComfyUIIterateStatus.setProperty(u"textRole", QCoreApplication.translate("ComfyUITab", u"help", None))
        self.ComfyUIIterateStatus.setText(QCoreApplication.translate("ComfyUITab", u"Ready", None))
        self.ComfyUIIterateProgress.setProperty(u"variant", QCoreApplication.translate("ComfyUITab", u"slim", None))
        self.ComfyUIIteratePreview.setProperty(u"variant", QCoreApplication.translate("ComfyUITab", u"sunken", None))
        self.ComfyUIIteratePreview.setText("")
        self.ComfyUIUseAsInput.setProperty(u"role", QCoreApplication.translate("ComfyUITab", u"secondary", None))
