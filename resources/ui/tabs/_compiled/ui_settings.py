...
class Ui_SettingsTab(object):
    def setupUi(self, SettingsTab):
        ...
        self.comfyuiFarmNoteLabel = QLabel(self.globalSettingsGroupBox)
        self.comfyuiFarmNoteLabel.setObjectName(u"comfyuiFarmNoteLabel")
        self.comfyuiFarmNoteLabel.setWordWrap(True)

        self.globalSettingsLayout.addWidget(self.comfyuiFarmNoteLabel)
        ...
        self.comfyuiVerifyLayout = QHBoxLayout()
        self.comfyuiVerifyLayout.setObjectName(u"comfyuiVerifyLayout")
        self.VerifyComfyUIPathButton = QPushButton(self.globalSettingsGroupBox)
        self.VerifyComfyUIPathButton.setObjectName(u"VerifyComfyUIPathButton")

        self.comfyuiVerifyLayout.addWidget(self.VerifyComfyUIPathButton)

        self.comfyuiVerifySpacer = QSpacerItem(0, 0, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.comfyuiVerifyLayout.addItem(self.comfyuiVerifySpacer)


        self.globalSettingsLayout.addLayout(self.comfyuiVerifyLayout)

        self.comfyuiVerifyStatus = QLabel(self.globalSettingsGroupBox)
        self.comfyuiVerifyStatus.setObjectName(u"comfyuiVerifyStatus")
        self.comfyuiVerifyStatus.setWordWrap(True)
        self.comfyuiVerifyStatus.setTextInteractionFlags(Qt.TextSelectableByMouse)
    ...
    def retranslateUi(self, SettingsTab):
        ...
        self.comfyuiFarmNoteLabel.setProperty(u"textRole", QCoreApplication.translate("SettingsTab", u"help", None))
        self.comfyuiFarmNoteLabel.setText(QCoreApplication.translate("SettingsTab", u"ComfyUI runs on Deadline farm workers, not on your machine. The paths below are resolved on the worker that picks up the job - they do not need to exist on this computer.", None))
...
#if QT_CONFIG(tooltip)
        self.ComfyUIModeButton.setToolTip(QCoreApplication.translate("SettingsTab", u"Installation type of ComfyUI on the farm worker", None))
#endif // QT_CONFIG(tooltip)
        self.comfyuiPathLabel.setText(QCoreApplication.translate("SettingsTab", u"ComfyUI Path (farm):", None))
        self.ComfyUIPathEdit.setPlaceholderText(QCoreApplication.translate("SettingsTab", u"Path to the ComfyUI installation on the farm worker...", None))
#if QT_CONFIG(tooltip)
        self.ComfyUIPathEdit.setToolTip(QCoreApplication.translate("SettingsTab", u"ComfyUI installation directory as seen by the Deadline worker. Resolved on the farm, not on this machine.", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.BrowseComfyUIPath.setToolTip(QCoreApplication.translate("SettingsTab", u"Browse for the directory. Convenience only - the path must be valid on the farm worker, not here.", None))
#endif // QT_CONFIG(tooltip)
        self.comfyuiPythonLabel.setText(QCoreApplication.translate("SettingsTab", u"Python Path (farm):", None))
...
#if QT_CONFIG(tooltip)
        self.ComfyUIPythonEdit.setToolTip(QCoreApplication.translate("SettingsTab", u"Python executable for standalone mode, as seen by the Deadline worker.", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.BrowseComfyUIPython.setToolTip(QCoreApplication.translate("SettingsTab", u"Browse for the executable. Convenience only - the path must be valid on the farm worker, not here.", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.VerifyComfyUIPathButton.setProperty(u"density", QCoreApplication.translate("SettingsTab", u"sm", None))
        self.VerifyComfyUIPathButton.setProperty(u"role", QCoreApplication.translate("SettingsTab", u"secondary", None))
        self.VerifyComfyUIPathButton.setText(QCoreApplication.translate("SettingsTab", u"Verify on Farm", None))
#if QT_CONFIG(tooltip)
        self.VerifyComfyUIPathButton.setToolTip(QCoreApplication.translate("SettingsTab", u"Send a quick Deadline job that checks these paths on a farm worker and reports back", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.NetworkOutputEdit.setToolTip(QCoreApplication.translate("SettingsTab", u"Shared network path for outputs - the only filesystem both your workstation and the farm can see.", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.vramModeLabel.setToolTip(QCoreApplication.translate("SettingsTab", u"ComfyUI GPU memory strategy. --lowvram and --highvram are mutually exclusive launch flags.", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.ComfyUIVRAMMode.setItemText(2, QCoreApplication.translate("SettingsTab", u"High VRAM (--highvram)", None))

#if QT_CONFIG(tooltip)
        self.ComfyUIVRAMMode.setToolTip(QCoreApplication.translate("SettingsTab", u"Auto: let ComfyUI decide. Low (--lowvram): least VRAM, slowest. High (--highvram): keep models in VRAM, needs high-end GPUs (24GB+).", None))
#endif // QT_CONFIG(tooltip)
